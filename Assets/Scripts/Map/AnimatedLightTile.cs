...
namespace UnityEngine.Tilemaps
{
    ...
    public class AnimatedLightTile : Tile
    {
#if UNITY_EDITOR
        // The following is a helper that adds a menu item to create a GroundTile Asset
        [MenuItem("Assets/Create/Tiles/AnimatedLightTile")]
        public static void CreateLightTile()
        {
            string path = EditorUtility.SaveFilePanelInProject("Save AnimatedLight Tile", "New AnimatedLight Tile", "Asset", "Save AnimatedLight Tile", "Assets");
            if (path == "")
            {
                return;
            }

            AssetDatabase.CreateAsset(ScriptableObject.CreateInstance<AnimatedLightTile>(), path);
        }
#endif
...
#if UNITY_EDITOR
    [CustomEditor(typeof(AnimatedLightTile))]
    public class AnimatedTileEditor : Editor
    {
        ...
        private AnimatedLightTile tile { get { return (target as AnimatedLightTile); } }
        ...
        public override void OnInspectorGUI()
        {
            ...
            tile.gameObject = (GameObject)EditorGUILayout.ObjectField("GameObject", tile.gameObject, typeof(GameObject), false);
